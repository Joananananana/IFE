        ...
        for(var i=1;i<trs.length;i++)
            trs[i].onmouseover=function(){
                ...
                for(var j=2;j<tds.length;j++){
                     data[0].sale[j-2]=tds[j].innerHTML;
                }
                column(data);
                line(data);
            }
    ...
    function line1(){
        ...
        for(var i=1;i<trs.length;i++)  {  
                ...
                for(var j=2;j<tds.length;j++){
                     data[i-1].sale[j-2]=tds[j].innerHTML;
                }
        }
        var color=["gold","seagreen","silver","black","blue","pink","green","red","yellow"] ;
        var sale=[];
        var max=0;
